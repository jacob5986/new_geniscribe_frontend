      ...
      <div className={classes.root}>
        ...
        <div className={classes.carouselHandle}>
          ...
          <nav className={classes.arrow}>
            <Button disabled={slideCount <= 0} variant="contained" color="primary" onClick={() => slider.current.slickPrev()} aria-label="prev" className={cx(classes.prev, classes.margin)}>
              <PrevIcon />
            </Button>
            <Button variant="contained" color="primary" onClick={() => slider.current.slickNext()} aria-label="next" className={cx(classes.next, classes.margin)}>
              <NextIcon />
            </Button>
          </nav>
        </div>
            ...
            <div className={classes.artwork}>
              <SliderArt fade={fade}>
                <div>
                  ...
                  <ScrollAnimation animateOnce animateIn="fadeInLeftShort" duration={0.5} offset={250} delay={300}>
                    <div>
                      <img
