  ...
  return (
    <Card className={cx(classes.profileCard, classes[orientation], classes[type])}>
      ...
      <CardActions className={classes.action}>
        ...
        >
          <BottomNavigationAction label={connection + ' Connection'} icon={<SupervisorAccount className={text.primaryColor} />} />
          <BottomNavigationAction label={favorites + ' Favorites'} icon={<Favorite className={text.secondaryColor} />} />
          <BottomNavigationAction label={albums + ' Albums'} icon={<PhotoLibrary className={text.accentColor} />} />
        </BottomNavigation>
